...
async function runGoogleSheetsWriter(date) {
  ...
  for (const product of products) {
    try {
      ...
      // Build list of image paths: 4 lifestyle mockups generated by DALL-E.
      // The listing-image.png (SVG render) is the actual download file — it is
      // not used as a listing photo here. Make uploads the mockups as Etsy photos.
      const imagePaths = [];
